...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/daily-reviews", destination: "/productivity?tab=review", permanent: false },
      ...
      { source: "/productivity/review", destination: "/productivity?tab=review", permanent: false },
